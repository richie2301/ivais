  ...
  return (
    <>
        ...
        <Space style={{width: '100%'}}>
            <Title level={4}>Create Case</Title>
        </Space>
        <Space direction="vertical" style={{width: '100%', marginTop: '10px'}}>
            <form>
                <Space direction='vertical' style={{width: '100%'}}>
                    <Text>Case Name</Text>
                    <Input placeholder="Enter case name" onChange={handleCaseName} />
                    {/* <Text>Location</Text>
                    ...
                    />
                    <Text>Case Type</Text>
                    <Select placeholder="Select case type" style={{ width: '100%' }} options={caseTypeOptions} onChange={handleCaseType} />
